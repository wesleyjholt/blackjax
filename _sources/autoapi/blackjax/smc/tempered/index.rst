...
.. py:function:: build_kernel(logprior_fn: Callable, loglikelihood_fn: Callable, mcmc_step_fn: Callable, mcmc_init_fn: Callable, resampling_fn: Callable, update_strategy: Callable = update_and_take_last, update_particles_fn: Optional[Callable] = None, resampling_strategy: Optional[Callable] = None) -> Callable
   ...
   :param resampling_strategy: Optional policy with signature
...
.. py:function:: as_top_level_api(logprior_fn: Callable, loglikelihood_fn: Callable, mcmc_step_fn: Callable, mcmc_init_fn: Callable, mcmc_parameters: dict, resampling_fn: Callable, num_mcmc_steps: Optional[int] = 10, update_strategy: Callable = update_and_take_last, update_particles_fn: Optional[Callable] = None, resampling_strategy: Optional[Callable] = None) -> blackjax.base.SamplingAlgorithm
   ...
   :param update_particles_fn: Optional custom function to update particles. If None, uses
                               smc_from_mcmc.build_kernel.
   :type update_particles_fn: Callable, optional
   :param resampling_strategy: Optional policy controlling whether reweighted particles are resampled
