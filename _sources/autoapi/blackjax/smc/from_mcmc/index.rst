...
.. py:function:: build_kernel(mcmc_step_fn: Callable, mcmc_init_fn: Callable, resampling_fn: Callable, update_strategy: Callable = update_and_take_last, resampling_strategy: Callable | None = None) -> Callable
   ...
   :param resampling_strategy: Optional resampling-decision policy. If omitted, the resulting SMC step
