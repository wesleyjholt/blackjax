...
.. py:function:: ess_solver(logdensity_fn: Callable, particles: blackjax.types.ArrayLikeTree, target_ess: float | blackjax.types.Array, max_delta: float | blackjax.types.Array, root_solver: Callable, current_log_weights: blackjax.types.Array | None = None) -> float | blackjax.types.Array
